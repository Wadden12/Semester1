...
# ABC Customer Analysis:Purchase Days
# Author: Mike Wadden
# Date: November 25, 2021

def Purchase_Days():
    """Report to show customers that have not made a purchase in more than 60 days"""
    import datetime
    ...
    if CusCount == 0:
        print("No Entries for Customers who have not made a purchase in 60 days")
